...
fun String.toFnrView() = this.substring(startIndex = 0, endIndex = 6) + " " + this.substring(6)

fun String.decapitalize(): String =
    if (!this.startsWith("NAV")) {
...
fun getBehandlingstidText(
    ...
    if (behandlingstidDate != null) {
        ...
        return behandlingstidUnits.toString() +
            when (
                TimeUnitType.of(
