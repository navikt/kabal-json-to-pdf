...
class GenerateInnholdsfortegnelsePDFTest {
    ...
    fun `generate pdf from full input`() {
        val data =
            InnholdsfortegnelseService().getInnholdsfortegnelsePDFAsByteArray(
        ...
        comparePdf(resource = "vedleggsoversikt", actualPdfBytes = data, outputSubfolder = outputSubfolder)
    }
}
